  ...
  return (
    ...
    >
              ...
              <div className="flex items-start justify-between">
                <div className="flex items-start gap-4 flex-1">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-3 mb-2">
                      ...
                      >
                        {getCryptoLabel(method.cryptoType)} on{' '}
                        {method.ecosystem.charAt(0).toUpperCase() + method.ecosystem.slice(1)}
                      </h4>
                      {method.isDefault && (
                ...
                <div className="flex items-center gap-2">
                  ...
                  <button
                    ...
                    aria-label={`Remove ${getCryptoLabel(method.cryptoType)} payment method`}
      ...
      {showAddModal &&
        createPortal(
          <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4">
            <div
              className={`relative w-full max-w-lg rounded-[24px] border shadow-[0_20px_60px_rgba(0,0,0,0.3)] p-8 overflow-hidden max-h-[90vh] overflow-y-auto ${
                theme === 'dark' ? 'bg-[#2d2820] border-white/20' : 'bg-[#f5efe5] border-white/40'
              }`}
            >
              <div className="flex items-center justify-between mb-6">
                <h3
              ...
              <div className="space-y-5">
                ...
                <div>
                  <label
                    className={`block text-[14px] font-semibold mb-3 transition-colors ${
                      theme === 'dark' ? 'text-[#f5efe5]' : 'text-[#2d2820]'
                    }`}
                  >
                    Select Token
                ...
                <div>
                  ...
                  {walletAddressError && (
                    <p
                      ...
                      role="alert"
                      className="text-[12px] mt-1 text-red-500"
                    >
                      {walletAddressError}
                    </p>
                  )}
                  ...
                  >
                    Make sure this address is correct. Payments sent to wrong addresses cannot be
                    recovered.
                  </p>
                </div>
              </div>
      ...
      >
        ...
        <ModalFooter>
          <ModalButton variant="secondary" onClick={() => setDeleteConfirmId(null)}>
            Cancel
          </ModalButton>
          <ModalButton
            variant="primary"
            onClick={() => {
              if (deleteConfirmId !== null) {
                onRemovePaymentMethod(deleteConfirmId)
