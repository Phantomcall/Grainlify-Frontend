...
describe('RoleSwitcher Accessibility and Features', () => {
  ...
  it('sets correct aria-checked and tabIndex attributes on buttons', () => {
    const { rerender } = renderWithTheme(
      <RoleSwitcher {...defaultProps} currentRole="contributor" />
    )
  ...
  it('supports click interactions to change role and close mobile nav', async () => {
    ...
    renderWithTheme(
      <RoleSwitcher {...defaultProps} onRoleChange={onRoleChange} closeMobileNav={closeMobileNav} />
    )
  ...
  it('navigates options backward with ArrowLeft and ArrowUp keys and wraps around', () => {
    ...
    const { rerender } = renderWithTheme(
      <RoleSwitcher {...defaultProps} currentRole="contributor" onRoleChange={onRoleChange} />
    )
    ...
    rerender(<RoleSwitcher {...defaultProps} currentRole="admin" onRoleChange={onRoleChange} />)
