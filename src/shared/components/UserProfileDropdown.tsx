      ...
      <DropdownMenuTrigger asChild>
        ...
        >
          ...
          <div className="flex flex-col items-start relative z-10 min-w-0">
            <span
              className={`text-[13px] font-medium leading-tight truncate max-w-[120px] ${
          ...
          <ChevronDown
            className={`w-3.5 h-3.5 transition-transform relative z-10 flex-shrink-0 ${
              darkTheme ? 'text-[rgba(255,255,255,0.69)]' : 'text-[rgba(45,40,32,0.75)]'
            }`}
          />
        </button>
        ...
        >
          <div className="flex items-center space-x-3">
            ...
            <div className="flex-1">
              ...
              <p className="text-xs text-[#c9983a] capitalize font-medium">{userRole}</p>
              <p className={`text-xs truncate ${darkTheme ? 'text-[#b8a898]' : 'text-[#7a6b5a]'}`}>
